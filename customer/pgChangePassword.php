...
if(!isset($_SESSION["Cusername"])){
	...
	$query="Select Password From cp_customerDetails Where Email='".$_SESSION["Cusername"]."'";
	//echo $query;
...
<script>
	...
	if($("#txtOldPassword").val()==""){
		...
		$.ajax({
			type:"POST",
			url:"changeCustomerPassword.php",
			...
			console.log(response);
				if($.trim(response)=="success"){
					...
					$("#txtNewPassword").val("");
					$("#txtRePassword").val("");
					$(location).attr('href','pgCustomerLogin.php');
				}
				else{
